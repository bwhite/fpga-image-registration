...
# /home/brandyn/fpga-image-registration/edk_project/blah.mhs
# The software specification of the system is in file :
# /home/brandyn/fpga-image-registration/edk_project/blah.mss
...
registration_test_program: $(REGISTRATION_TEST_OUTPUT) 

$(REGISTRATION_TEST_OUTPUT) : $(REGISTRATION_TEST_SOURCES) $(REGISTRATION_TEST_HEADERS) $(REGISTRATION_TEST_LINKER_SCRIPT) \
                    $(LIBRARIES) __xps/registration_test_compiler.opt
	@mkdir -p $(REGISTRATION_TEST_OUTPUT_DIR) 
	$(REGISTRATION_TEST_CC) $(REGISTRATION_TEST_CC_OPT) $(REGISTRATION_TEST_SOURCES) -o $(REGISTRATION_TEST_OUTPUT) \
	$(REGISTRATION_TEST_OTHER_CC_FLAGS) $(REGISTRATION_TEST_INCLUDES) $(REGISTRATION_TEST_LIBPATH) \
	$(REGISTRATION_TEST_CFLAGS) $(REGISTRATION_TEST_LFLAGS) 
	$(REGISTRATION_TEST_CC_SIZE) $(REGISTRATION_TEST_OUTPUT) 
	@echo ""

registration_test_programclean:
	rm -f $(REGISTRATION_TEST_OUTPUT) 
