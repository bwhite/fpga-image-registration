...
proc import { {working_area ""} {staging_area ""} { srcctrl_comp 0 } } {
  set project_file "fetch_stage.ise"
  ...
  set process_props { 
      ...
      "A" "AutoGeneratedView" "VIEW_AbstractSimulation" "" "PROP_TopDesignUnit" "Module|fetch_stage_tbw0" 
      ...
      "A" "AutoGeneratedView" "VIEW_Post-MapAbstractSimulation" "" "PROP_TopDesignUnit" "Module|conv2d1d_tbw" 
      "A" "AutoGeneratedView" "VIEW_Post-MapPreSimulation" "" "PROP_TopDesignUnit" "" 
      "A" "AutoGeneratedView" "VIEW_Post-ParAbstractSimulation" "" "PROP_TopDesignUnit" "Module|conv2d1d_tbw" 
      ...
      "A" "AutoGeneratedView" "VIEW_Post-SynthesisAbstractSimulation" "" "PROP_TopDesignUnit" "Module|conv2d1d_tbw" 
      "A" "AutoGeneratedView" "VIEW_Post-TranslateAbstractSimulation" "" "PROP_TopDesignUnit" "Module|conv2d1d_tbw" 
      "A" "AutoGeneratedView" "VIEW_Post-TranslatePreSimulation" "" "PROP_TopDesignUnit" "" 
      "A" "AutoGeneratedView" "VIEW_PostAbstractSimulation" "" "PROP_TopDesignUnit" "Module|fetch_stage_tbw0" 
      ...
      "A" "AutoGeneratedView" "VIEW_PreSimulation" "" "PROP_TopDesignUnit" "Architecture|convert_2d_to_1d_coord|Behavioral" 
      "A" "AutoGeneratedView" "VIEW_Structural" "" "PROP_TopDesignUnit" "Module|fetch_stage" 
      ...
      "A" "AutoGeneratedView" "VIEW_TBWPreSimulation" "" "PROP_TopDesignUnit" "Architecture|fetch_stage_tbw0|testbench_arch" 
      ...
      "A" "AutoGeneratedView" "VIEW_XSTAbstractSynthesis" "" "PROP_TopDesignUnit" "Architecture|fetch_stage|Behavioral" 
      "A" "AutoGeneratedView" "VIEW_XSTPreSynthesis" "" "PROP_TopDesignUnit" "Architecture|fetch_stage|Behavioral" 
      "A" "AutoGeneratedView" "VIEW_XSTPreSynthesis" "" "PROP_xstVeriIncludeDir" "" 
      "A" "VIEW_Initial" "VIEW_Initial" "" "PROP_TopDesignUnit" "Module|conv2d1d_tbw" 
      ...
      "B" "" "" "" "PROP_parGenAsyDlyRpt_virtex5" "true" 
      "B" "" "" "" "PROP_parGenClkRegionRpt_virtex5" "true" 
      ...
      "G" "" "" "" "PROP_PostSynthSimModelName" "fetch_stage_synthesis.vhd" 
      ...
      "G" "AutoGeneratedView" "VIEW_Post-MapAbstractSimulation" "" "PROP_tbwPostMapTestbenchName" "conv2d1d_tbw.map_vhw" 
      "G" "AutoGeneratedView" "VIEW_Post-ParAbstractSimulation" "" "PROP_tbwPostParTestbenchName" "conv2d1d_tbw.timesim_vhw" 
      "G" "AutoGeneratedView" "VIEW_Post-TranslateAbstractSimulation" "" "PROP_tbwPostXlateTestbenchName" "conv2d1d_tbw.translate_vhw" 
      ...
      "H" "AutoGeneratedView" "VIEW_Structural" "" "PROP_SimModelRenTopLevEntTo" "fetch_stage" 
  ...
  HandleException {
   ...
   set opts_stream [ [Xilinx::Cit::FactoryCreate $::xilinx::Dpm::StreamBufferCompID ]  GetInterface $xilinx::Prjrep::IStreamID ] 
     ...
     $opts_stream WriteString "0"
     $opts_stream WriteString "29"
     $opts_stream WriteString "conv2d1d_tbw.map_vhw"
     $opts_stream WriteString "conv2d1d_tbw.map_vhw"
     $opts_stream WriteString "conv2d1d_tbw.map_vhw"
     $opts_stream WriteString "conv2d1d_tbw.map_vhw"
     $opts_stream WriteString "conv2d1d_tbw.map_vhw"
     $opts_stream WriteString "conv2d1d_tbw.timesim_vhw"
     $opts_stream WriteString "conv2d1d_tbw.timesim_vhw"
     $opts_stream WriteString "conv2d1d_tbw.timesim_vhw"
     $opts_stream WriteString "conv2d1d_tbw.timesim_vhw"
     $opts_stream WriteString "conv2d1d_tbw.timesim_vhw"
     $opts_stream WriteString "conv2d1d_tbw.translate_vhw"
     $opts_stream WriteString "conv2d1d_tbw.translate_vhw"
     $opts_stream WriteString "conv2d1d_tbw.translate_vhw"
     $opts_stream WriteString "conv2d1d_tbw.translate_vhw"
     $opts_stream WriteString "conv2d1d_tbw.translate_vhw"
     $opts_stream WriteString "/home/brandyn/fpga-image-registration/modules/fetch_stage/conv2d1d_tbw.tbw"
     $opts_stream WriteString "/home/brandyn/fpga-image-registration/modules/fetch_stage/conv2d1d_tbw.xwv"
     $opts_stream WriteString "/home/brandyn/fpga-image-registration/modules/fetch_stage/convert_2d_to_1d_coord_guide.ncd"
     $opts_stream WriteString "/home/brandyn/fpga-image-registration/modules/fetch_stage/conv_pixel_ordering_tbwnew0.tbw"
     $opts_stream WriteString "/home/brandyn/fpga-image-registration/modules/fetch_stage/conv_pixel_ordering_tbwnew0.xwv"
     $opts_stream WriteString "/home/brandyn/fpga-image-registration/modules/fetch_stage/conv_pixel_ordering_tbwnew1.tbw"
     $opts_stream WriteString "/home/brandyn/fpga-image-registration/modules/fetch_stage/conv_pixel_ordering_tbwnew1.xwv"
     $opts_stream WriteString "/home/brandyn/fpga-image-registration/modules/fetch_stage/conv_pix_ordering_mem_addr_select_test_guide.ncd"
     $opts_stream WriteString "/home/brandyn/fpga-image-registration/modules/fetch_stage/fetch_stage_guide.ncd"
     $opts_stream WriteString "/home/brandyn/fpga-image-registration/modules/fetch_stage/fetch_stage_tbw0.xwv"
     $opts_stream WriteString "/home/brandyn/fpga-image-registration/modules/fetch_stage/mem_addr_select_tbw.tbw"
     $opts_stream WriteString "/home/brandyn/fpga-image-registration/modules/fetch_stage/mem_addr_select_tbw.xwv"
