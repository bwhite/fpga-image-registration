...
cd [file normalize {/home/brandyn/fpga-image-registration/modules/vga_input_test} ]
set copy_option relative
set staging_area "/home/brandyn/fpga-image-registration/modules/vga_input_test"
set export_files { 
          "vga_cs0.cdc" 
          "vga_input.ucf" 
          "vga_input.vhd" 
...
CopyOut "/home/brandyn/fpga-image-registration/modules/vga_input_test/vga_input_test_import.tcl" "$staging_area" nop
# return back
cd $old_working_dir
